...
cmake -G "Visual Studio 11 Win64" -DGLEW_LOCATION:string=%GLEW_PATH% -DMAYA_LOCATION:string=%MAYA_PATH% -DNO_REGRESSION=1 -DNO_PYTHON=1 -DNO_DOC=1 -DNO_OMP=1 -DNO_CUDA=1 -DNO_GCD=1
